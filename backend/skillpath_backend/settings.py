"""
Django settings for skillpath_backend project.
"""
...
# Connects to PostgreSQL if DATABASE_URL is set in environment (e.g. postgresql://user:pass@host:5432/dbname)
# Falls back to SQLite for local zero-dependency testing.
